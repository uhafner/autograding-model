...
class AnalysisMarkdownTest {
    private static final String IMPACT_CONFIGURATION = ":moneybag:|-|-|*-1*|*-2*|*-3*|*-4*|-|-";
    ...
    void shouldShowScoreWithOneResult() {
        ...
        assertThat(analysisMarkdown.createDetails(score))
                ...
                .contains("|:custom-icon:|CS|project|1|2|3|4|10|-30")
                .contains(IMPACT_CONFIGURATION);
    }
    ...
    void shouldShowScoreWithTwoSubResults() {
        ...
        assertThat(analysisMarkdown.createDetails(score))
                .contains("CheckStyle - 50 of 100",
                        "|CheckStyle|project|1|2|3|4|10|-30",
                        "|SpotBugs|project|4|3|2|1|10|-20",
    ...
    void shouldShowNoImpactsWithTwoSubResults() {
        ...
        assertThat(analysisMarkdown.createDetails(score))
                .contains("CheckStyle",
                        "|CheckStyle|project|1|2|3|4|10",
                        "|SpotBugs|project|4|3|2|1|10",
                        "**Total**|**-**|**5**|**5**|**5**|**5**|**20**")
    ...
    void shouldShowScoreWithTwoResults() {
        ...
        assertThat(analysisMarkdown.createDetails(score))
                .contains("Style - 60 of 100",
                        "|CheckStyle 1|project|1|2|3|4|10|30",
                        "|CheckStyle 2|project|1|2|3|4|10|30",
                        "|**Total**|**-**|**2**|**4**|**6**|**8**|**20**|**60**",
                        ":moneybag:|-|-|*1*|*2*|*3*|*4*|-|-",
                        "Bugs - 0 of 100",
                        "|SpotBugs 1|project|4|3|2|1|10|-120",
                        "|SpotBugs 2|project|4|3|2|1|10|-120",
                        "|**Total**|**-**|**8**|**6**|**4**|**2**|**20**|**-240**",
                        ":moneybag:|-|-|*-11*|*-12*|*-13*|*-14*|-|-");
        assertThat(analysisMarkdown.createSummary(score)).contains(
