...
class FileSystemToolParserTest {
    ...
    void shouldCreateAggregation() {
        ...
        assertThat(gradingReport.getMarkdownSummary(score)).contains(
                ...
                "CheckStyle (Whole Project) - 6 of 100: 6 warnings &mdash; error: 6",
                "<img src=\"https://raw.githubusercontent.com/pmd/pmd/master/docs/images/logo/PMD_small.svg\"",
                "PMD (Whole Project) - 12 of 100: 4 warnings &mdash; high: 1, normal: 2, low: 1",
                ...
                "SpotBugs (Whole Project) - 72 of 100: 2 bugs &mdash; low: 2",
                ":bug:",
                "Error Prone (Whole Project) - 87 of 100: 1 bug &mdash; normal: 1");
    }
