...
class QualityGateTest {
    ...
    void shouldSupportDifferentCriticalityLevels() {
        ...
        var gateError = new QualityGate("Test", "line", 80.0, QualityGate.Criticality.ERROR);
        var gateNote = new QualityGate("Test", "line", 80.0, QualityGate.Criticality.NOTE);
        ...
        assertThat(gateError.getCriticality()).isEqualTo(QualityGate.Criticality.ERROR);
        assertThat(gateNote.getCriticality()).isEqualTo(QualityGate.Criticality.NOTE);
    }
