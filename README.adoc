...
image:https://github.com/uhafner/autograding-model/workflows/CI%20on%20all%20platforms/badge.svg?branch=master[GitHub Actions, link=https://github.com/uhafner/autograding-model/actions]
