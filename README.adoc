...
image:https://github.com/uhafner/autograding-model/workflows/GitHub%20CI/badge.svg?branch=main[GitHub Actions, link=https://github.com/uhafner/autograding-model/actions]
